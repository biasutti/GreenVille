...
public class DisableCompressedCobblestoneStairsL {
    ...
    @Getter
    String key = "disable_compressed_cobblestone_stairs_l";

    public DisableCompressedCobblestoneStairsL(Plugin plugin) {
